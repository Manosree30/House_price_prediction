...
# --- Feature engineering ---
input_dict['area_per_story'] = area / stories if stories else 0
input_dict['bed_bath_ratio'] = bedrooms / bathrooms if bathrooms else 0
input_dict['rooms_per_story'] = bedrooms / stories if stories else 0
input_dict['parking_per_story'] = parking / stories if stories else 0
...
# --- Identify numeric columns (must match training phase) ---
numeric_cols = [
